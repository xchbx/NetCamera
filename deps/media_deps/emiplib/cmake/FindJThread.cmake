...
set(JTHREAD_INCLUDE_DIRS "${CMAKE_SOURCE_DIR}/deps/media_deps/JThread/src")
set(JTHREAD_LIBRARIES "${CMAKE_SOURCE_DIR}/build/lib")
...
if (NOT JTHREAD_FOUND) # Config file could not be found
    ...
    MESSAGE(STATUS "0000JTHREAD_INCLUDE_DIR--------${JTHREAD_INCLUDE_DIR}")
