...
MESSAGE(STATUS "JTHREAD_INCLUDE_DIRS--------$ENV{JTHREAD_INCLUDE_DIRS}")

if (NOT JTHREAD_FOUND) # Config file could not be found
	find_path($ENV{JTHREAD_INCLUDE_DIRS} jthread/jthread.h)
	
	set(JTHREAD_INCLUDE_DIRS $ENV{JTHREAD_INCLUDE_DIRS})

	MESSAGE(STATUS "0000JTHREAD_INCLUDE_DIR--------${JTHREAD_INCLUDE_DIRS}")
	MESSAGE(STATUS "111 JTHREAD_LIBRARY ----${JTHREAD_LIBRARY}")
	if (UNIX)
